...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "text-foreground **:[[cmdk-group-heading]]:text-muted-foreground p-1 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:font-medium",
        className,
      )}
      {...props}
    />
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        // Destaque claro e compatível com seu tema (secondary claro)
        "data-[selected=true]:bg-(--quaternary-color) data-[selected=true]:text-(--primary-color)",
        className,
      )}
      {...props}
    />
